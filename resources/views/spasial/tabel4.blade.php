...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel4/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k2" name="k2" placeholder="k2">
                                    <option value=""></option>
                                    <option value="1">1. Masjid</option>
                                    <option value="2">2. Musholla</option>
                                    <option value="3">3. Gereja</option>
                                    <option value="4">4. Pura/Vihara</option>
                                </select>
                                <label for="k2" class="form-label">2. Jenis Tempat Ibadah</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k3" class="form-label">3. Nama Tempat Ibadah</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k4" class="form-label">4. Nama Pengurus</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k5" class="form-label">5. Luas (m2)</label>
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->jenis)
                                @case('1') 1. Masjid @break
                                @case('2') 2. Musholla @break
                                @case('3') 3. Gereja @break
                                @case('4') 4. Pura/Vihara @break
                                @default {{ $d->jenis }}
                            @endswitch
                        </td>
                        <td>{{ $d->nama }}</td>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel4/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
