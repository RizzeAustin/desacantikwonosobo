...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel2/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <label for="k4" class="form-label">4. Nama Ketua RW</label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k5" class="form-label">5. Jenis Kelamin</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k6" class="form-label">6. Usia</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k7" class="form-label">7. Pendidikan Terakhir</label>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel2/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
