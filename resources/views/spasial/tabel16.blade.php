...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel16/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                ...
                                <label for="k2" class="form-label">2. Nama Unit Kesenian dan Sarana Rekreasi</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k3" class="form-label">3. Nama Ketua</label>
        ...
        <table id="dataTable" class="table table-bordered table-stripped display nowrap">
            <thead>
                <tr class="v-mid t-center">
                    <th>No</th>
                    <th>Nama Unit Kesenian Dan Sarana Rekreasi</th>
                    <th>Nama Ketua</th>
                    <th>Tahun Berdiri</th>
                    <th>Dusun</th>
                    <th>RW</th>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel16/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
