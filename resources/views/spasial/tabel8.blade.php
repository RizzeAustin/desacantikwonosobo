...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel8/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k2" name="k2" placeholder="k2">
                                    <option value=""></option>
                                    <option value="1">1. TPA/ TPQ</option>
                                    <option value="2">2. Pondok Pesantren</option>
                                    <option value="3">3. Majlis Taklim</option>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k4" class="form-label">4. Jumlah Ustadz</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k5" class="form-label">5. Jumlah Santri</label>
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->jenjang)
                                @case('1') 1. TPA/ TPQ @break
                                @case('2') 2. Pondok Pesantren @break
                                @case('3') 3. Majlis Taklim @break
                                @default {{ $d->jenjang }}
                            @endswitch
                        </td>
                        <td>{{ $d->nama }}</td>
                        <td>{{ $d->jumlahustadz}}</td>
                        <td>{{ $d->jumlahsantri }}</td>
                        <td>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel8/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
            ...
            success: function(data){
                ...
                $('#k2').val(d.jenjang)
                $('#k3').val(d.nama)
                $('#k4').val(d.jumlahustadz)
                $('#k5').val(d.jumlahsantri)
