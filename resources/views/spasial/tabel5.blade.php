...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel5/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                ...
                                <label for="k2" class="form-label">2. Kepenguasaan</label>
                                <small><span class="text-danger error-text k2_err"></span></small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k3" name="k3" placeholder="k3">
                                    <option value=""></option>
                                    <option value="1">1. Sawah</option>
                                    <option value="2">2. Kering</option>
                                    <option value="3">3. Kolam</option>
                                    <option value="4">4. Lainnya</option>
                                </select>
                                <label for="k3" class="form-label">3. Jenis Tanah</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k4" class="form-label">4. Luas (m2)</label>
        ...
        <table id="dataTable" class="table table-bordered table-stripped display nowrap">
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        <td>{{ $d->id }}</td>
                        <td>{{ $d->kepenguasaan }}</td>
                        <td>
                            @switch($d->jenis)
                                @case('1') 1. Sawah @break
                                @case('2') 2. Kering @break
                                @case('3') 3. Kolam @break
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel5/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
