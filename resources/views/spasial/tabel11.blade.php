...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel11/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                ...
                                <label for="k2" class="form-label">2. Nama Fasilitas Kesehatan</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k3" class="form-label">3. Jumlah Tenaga Kesehatan</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k4" class="form-label">4. Tahun Berdiri</label>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel11/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
            ...
            success: function(data){
                ...
                $('#k1').val(d.id)
                $('#k2').val(d.nama)
                $('#k3').val(d.jumlahtenaga)
                $('#k4').val(d.tahunberdiri)
