...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel25/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                ...
                                <label for="k2" class="form-label">2. Nama Jembatan</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <label for="k3" class="form-label">3. Kondisi Jembatan</label>
                ...
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->kondisi)
                                @case('1') 1. baik @break
                                @case('2') 2. Sedang @break
                                @case('3') 3. Rusak @break
                                @default {{ $d->kondisi }}
                            @endswitch    
                        </td>
                        <td>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel25/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
