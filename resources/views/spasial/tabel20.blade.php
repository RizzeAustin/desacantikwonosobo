...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel20/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k2" name="k2" placeholder="k2">
                                    <option value=""></option>
                                    <option value="1">1. Bank Umum </option>
                                    <option value="2">2. Bank Swasta </option>
                                    <option value="3">3. Bank Perkreditan Rakyat </option>
                                </select>
                                <label for="k2" class="form-label">2. Sarana lembaga Keuangan</label>
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->jenis)
                                @case('1') 1. Bank Umum @break
                                @case('2') 2. Bank Swasta @break
                                @case('3') 3. Bank Perkreditan Rakyat @break
                                @default {{ $d->jenis }}
                            @endswitch    
                        </td>
                        <td>{{ $d->nama }}</td>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel20/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
