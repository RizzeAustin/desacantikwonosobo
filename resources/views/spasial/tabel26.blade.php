...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel26/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                ...
                                <label for="k2" class="form-label">2. Jenis Lembaga Keamanan</label>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel26/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
