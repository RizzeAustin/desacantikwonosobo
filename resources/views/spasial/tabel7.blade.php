...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel7/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k2" name="k2" placeholder="k2">
                                    <option value=""></option>
                                    <option value="1">1. PAUD</option>
                                    <option value="2">2. TK</option>
                                    <option value="3">3. SD/MI</option>
                                    <option value="4">4. SMP/Mts</option>
                                    <option value="5">5. SMA/SMK</option>
                                    <option value="6">6. Akademi/Perguruantinggi</option>
                                </select>
                                <label for="k2" class="form-label">2. Jenjang Pendidikan</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <label for="k3" class="form-label">3. Nama Sekolah</label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k4" class="form-label">4. Jumlah Guru</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k5" class="form-label">5. Jumlah Murid</label>
                                <small><span class="text-danger error-text k5_err"></span></small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k6" name="k6" placeholder="k6">
                                    <option value=""></option>
                                    <option value="1">1. Negeri</option>
                                    <option value="2">2. Swasta</option>
                                </select>
                                <label for="k6" class="form-label">6. Status Sekolah</label>
                    ...
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->jenjang)
                                @case('1') 1. PAUD @break
                                @case('2') 2. TK @break
                                @case('3') 3. SD/MI @break
                                @case('4') 4. SMP/Mts @break
                                @case('5') 5. SMA/SMK @break
                                @case('6') 6. Akademi/Perguruantinggi @break
                                @default {{ $d->jenjang }}
                            @endswitch
                        </td>
                        <td>{{ $d->nama }}</td>
                        ...
                        <td>
                            @switch($d->status)
                                @case('1') 1. Negeri @break
                                @case('2') 2. Swasta @break
                                @default {{ $d->status }}
                            @endswitch
                        </td>
                        <td>
...
<script>
    $(document).ready(function(){
        ...
        var dataTable = $('#dataTable').DataTable({
            ...
            initComplete: function () {
                this.api().columns([1,5,6,7,8,9]).every( function () {
                    var column = this;
                    ...
                    if($.isEmptyObject(data.error)){
                        ...
                        $("#dataTable tbody tr").each(function () {
                            ...
                            if (no==$('#k1').val()){
                                ...
                                t.find("td:eq(6)").html($('#dusun option:selected').text())
                                t.find("td:eq(7)").html($('#rw option:selected').text())
                                t.find("td:eq(8)").html($('#rt option:selected').text())
                                t.find("td:eq(9)").html($('#flag option:selected').text())
                                return false
                            }
                        });
                        if (tidakAda){
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel7/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
