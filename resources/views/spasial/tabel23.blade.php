...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel23/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k2" name="k2" placeholder="k2">
                                    <option value=""></option>
                                    <option value="1">1. Tratag </option>
                                    <option value="2">2. Meja-Kursi </option>
                                    <option value="3">3. Piring-sendok </option>
                                    <option value="4">4. Sound system </option>
                                    <option value="5">5. Pakaian pengantin </option>
                                    <option value="6">6. Mobil </option>
                                    <option value="7">7. Playstation </option>
                                </select>
                                <label for="k2" class="form-label">2. Jenis Usaha Persewaan</label>
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->jenis)
                                @case('1') 1. Tratag @break
                                @case('2') 2. Meja-Kursi @break
                                @case('3') 3. Piring-sendok @break
                                @case('4') 4. Sound system @break
                                @case('5') 5. Pakaian pengantin @break
                                @case('6') 6. Mobil @break
                                @case('7') 7. Playstation @break
                                @default {{ $d->jenis }}
                            @endswitch    
                        </td>
                        <td>{{ $d->nama }}</td>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel23/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
