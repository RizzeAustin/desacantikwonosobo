...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel21/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k2" name="k2" placeholder="k2">
                                    <option value=""></option>
                                    <option value="1">1. KUD </option>
                                    <option value="2">2. Kopinkra </option>
                                    <option value="3">3. Kospin </option>
                                    <option value="4">4. Lainnya </option>
                                </select>
                                <label for="k2" class="form-label">2. Koperasi yang Masih Aktif</label>
        ...
        <table id="dataTable" class="table table-bordered table-stripped display nowrap">
            <thead>
                <tr class="v-mid t-center">
                    <th>No</th>
                    <th>Koperasi yang Masih Aktif</th>
                    <th>Nama</th>
                ...
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->jenis)
                                @case('1') 1. KUD @break
                                @case('2') 2. Kopinkra @break
                                @case('3') 3. Kospin @break
                                @case('4') 4. Lainnya @break
                                @default {{ $d->jenis }}
                            @endswitch    
                        </td>
                        <td>{{ $d->nama }}</td>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel21/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
