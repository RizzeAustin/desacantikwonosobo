...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel19/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k2" name="k2" placeholder="k2">
                                    <option value=""></option>
                                    <option value="1">1. Pertokoan </option>
                                    <option value="2">2. Pasar dengan bangunan permanen </option>
                                    <option value="3">3. Pasar dengan bangunan semipermanen </option>
                                    <option value="4">4. Pasar tanpa bangunan </option>
                                    <option value="5">5. Minimarket/ swalayan </option>
                                    <option value="6">6. Warung/ kelontong </option>
                                    <option value="7">7. Restoran/ rumah makan </option>
                                </select>
                                <label for="k2" class="form-label">2. Jenis Sarana Prasarana Ekonomi</label>
                                <small><span class="text-danger error-text k2_err"></span></small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-floating">
                                <input type="number" class="form-control" id="k3" name="k3" placeholder="k3" value="" min="0">
                                <label for="k3" class="form-label">3. Tahun Berdiri</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k4" class="form-label">4. Banyak Pekerja/Pedagang</label>
        ...
        <table id="dataTable" class="table table-bordered table-stripped display nowrap">
            <thead>
                <tr class="v-mid t-center">
                    <th>No</th>
                    <th>Jenis Sarana Prasarana Ekonomi</th>
                    <th>Tahun Berdiri</th>
                    <th>Banyak Pekerja/Pedagang</th>
                    <th>Dusun</th>
                    <th>RW</th>
                    <th>RT</th>
                    <th>Flag</th>
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->jenis)
                                @case('1') 1. Pertokoan @break
                                @case('2') 2. Pasar dengan bangunan permanen @break
                                @case('3') 3. Pasar dengan bangunan semipermanen @break
                                @case('4') 4. Pasar tanpa bangunan @break
                                @case('5') 5. Minimarket/ swalayan @break
                                @case('6') 6. Warung/ kelontong @break
                                @case('7') 7. Restoran/ rumah makan @break
                                @default {{ $d->jenis }}
                            @endswitch    
                        </td>
                        <td>{{ $d->tahunberdiri }}</td>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel19/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
