...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel1/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <label for="k3" class="form-label">3. Nama Ketua Dusun</label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k4" name="k4" placeholder="kode">
                                    <option value=""></option>
                                    <option value="1">1. Laki-Laki</option>
                                    <option value="2">2. Perempuan</option>
                                </select>
                                <label for="k4" class="form-label">4. Jenis Kelamin</label>
                                <small><span class="text-danger error-text k4_err"></span></small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k5" name="k5" placeholder="kode">
                                    <option value=""></option>
                                ...
                                <label for="k5" class="form-label">5. Usia</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                ...
                                <label for="k6" class="form-label">6. Pendidikan Terakhir</label>
...
<script>
                    ...
                    if($.isEmptyObject(data.error)){
                        ...
                        $("#dataTable tbody tr").each(function () {
                            ...
                            if (no==$('#k1').val()){
                                ...
                                t.find("td:eq(3)").html($('#k4 option:selected').text())
                                t.find("td:eq(4)").html($('#k5 option:selected').text())
                        ...
                        if (tidakAda){
                            dataTable.row.add( [
                                ...
                                $('#k2').val(),
                                $('#k3').val(),
                                $('#k4 option:selected').text(),
                                $('#k5 option:selected').text(),
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel1/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
