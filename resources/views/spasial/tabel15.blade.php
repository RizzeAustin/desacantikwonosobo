...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel15/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                        ...
                        <div class="col-md-11">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k2" name="k2" placeholder="k2">
                                    <option value=""></option>
                                    <option value="1">1. Lapangan Sepak Bola </option>
                                    <option value="2">2. Lapangan Bulu Tangkis </option>
                                    <option value="3">3. Lapangan Bola Voli </option>
                                    <option value="4">4. Lapangan Bola Basket </option>
                                    <option value="5">5. Tenis Meja </option>
                                    <option value="6">6. Sanggar Senam </option>
                                    <option value="7">7. Fitness </option>
                                </select>
                                <label for="k2" class="form-label">2. Jenis Sarana Olahraga</label>
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->jenis)
                                @case('1') 1. Lapangan Sepak Bola @break
                                @case('2') 2. Lapangan Bulu Tangkis @break
                                @case('3') 3. Lapangan Bola Voli @break
                                @case('4') 4. Lapangan Bola Basket @break
                                @case('5') 5. Tenis Meja @break
                                @case('6') 6. Sanggar Senam @break
                                @case('7') 7. Fitness @break
                                @default {{ $d->jenis }}
                            @endswitch    
                        </td>
                        <td>
...
<script>
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel15/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
