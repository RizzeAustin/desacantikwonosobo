...
<div class="row mt-4">
    <div class="col-xl">
        <div class="card mb-4 border-dark">
            ...
            <div class="card-body">
                <form action="{{ url('/spasial/tabel24/add') }}" method="POST" id="form" class="form-spasial" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-floating">
                                <select type="text" class="form-select" id="k2" name="k2" placeholder="k2">
                                    <option value=""></option>
                                    <option value="1">1. Tukang kayu/ batu </option>
                                    <option value="2">2. Penjahit </option>
                                    <option value="3">3. Fotostudio </option>
                                    <option value="4">4. Sablon </option>
                                    <option value="5">5. Tukang cukur </option>
                                    <option value="6">6. Sol sepatu </option>
                                    <option value="7">7. Jasa cuci mobil-motor </option>
                                    <option value="8">8. Tukang las </option>
                                    <option value="9">9. Tukang pijat </option>
                                    <option value="10">10. Fotokopi </option>
                                    <option value="11">11. Reparasi elektronik </option>
                                    <option value="12">12. Reparasi jam </option>
                                    <option value="13">13. Bengkel sepeda </option>
                                    <option value="14">14. Bengkel motor </option>
                                    <option value="15">15. Bengkel mobil </option>
                                    <option value="16">16. Pandai besi </option>
                                    <option value="17">17. Kos/ sewa rumah </option>
                                    <option value="18">18. Salon kecantikan </option>
                                    <option value="19">19. Rias pengantin </option>
                                    <option value="20">20. Sanggar senam </option>
                                    <option value="21">21. kursus keterampilan </option>
                                    <option value="22">22. kursus bahasa </option>
                                    <option value="23">23. lainnya </option>
                                </select>
                                <label for="k2" class="form-label">2. Jenis Usaha Sektor Jasa</label>
                                <small><span class="text-danger error-text k2_err"></span></small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="k3" name="k3" placeholder="k3" value="">
                                <label for="k3" class="form-label">3. Nama</label>
                                <small><span class="text-danger error-text k3_err"></span></small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-floating">
                                <input type="number" class="form-control" id="k4" name="k4" placeholder="k4" value="" min="0">
                                <label for="k4" class="form-label">4. Banyak Pekerja</label>
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr class="v-mid t-center">
                        ...
                        <td>
                            @switch($d->jenis)
                                @case('1') 1. Tukang kayu/ batu @break
                                @case('2') 2. Penjahit @break
                                @case('3') 3. Fotostudio @break
                                @case('4') 4. Sablon @break
                                @case('5') 5. Tukang cukur @break
                                @case('6') 6. Sol sepatu @break
                                @case('7') 7. Jasa cuci mobil-motor @break
                                @case('8') 8. Tukang las @break
                                @case('9') 9. Tukang pijat @break
                                @case('10') 10. Fotokopi @break
                                @case('11') 11. Reparasi elektronik @break
                                @case('12') 12. Reparasi jam @break
                                @case('13') 13. Bengkel sepeda @break
                                @case('14') 14. Bengkel motor @break
                                @case('15') 15. Bengkel mobil @break
                                @case('16') 16. Pandai besi @break
                                @case('17') 17. Kos/ sewa rumah @break
                                @case('18') 18. Salon kecantikan @break
                                @case('19') 19. Rias pengantin @break
                                @case('20') 20. Sanggar senam @break
                                @case('21') 21. kursus keterampilan @break
                                @case('22') 22. kursus bahasa @break
                                @case('23') 23. lainnya @break
                                @default {{ $d->jenis }}
                            @endswitch    
                        </td>
                        <td>{{ $d->nama }}</td>
                        <td>{{ $d->jumlahpekerja }}</td>
                        <td>
...
<script>
    $(document).ready(function(){
        ...
        var dataTable = $('#dataTable').DataTable({
            ...
            initComplete: function () {
                this.api().columns([1,4,5,6,7]).every( function () {
                    var column = this;
                    ...
                    if($.isEmptyObject(data.error)){
                        ...
                        $("#dataTable tbody tr").each(function () {
                            ...
                            if (no==$('#k1').val()){
                                ...
                                t.find("td:eq(2)").html($('#k3').val())
                                t.find("td:eq(3)").html($('#k4').val())

                                t.find("td:eq(4)").html($('#dusun option:selected').text())
                                t.find("td:eq(5)").html($('#rw option:selected').text())
                                t.find("td:eq(6)").html($('#rt option:selected').text())
                                t.find("td:eq(7)").html($('#flag option:selected').text())
                                return false
                            }
                        });
                        if (tidakAda){
    ...
    function edit(id){
        let url = `{{ url('/spasial/tabel24/data') }}`
        $.ajax({
            url: url,
            type: "POST",
            data:{ 
