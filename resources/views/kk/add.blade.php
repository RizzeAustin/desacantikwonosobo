    ...
    <div class="modal-dialog" role="document" style="min-width: 80vw">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ url('/data/add/blok4table') }}" method="POST" id="blok4FormTable" class="form-tambah" autocomplete="off">
                @csrf
                            ...
                            <table width=100%>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-check-input mt-1" type="checkbox" id="b4k9_2">
                                            <label class="form-check-label" for="b4k9_2"> 2. Kartu pelajar </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input class="form-check-input mt-1" type="checkbox" id="b4k9_0">
                                            <label class="form-check-label" for="b4k9_2"> 0. Tidak memiliki </label>
                                        </td>
                                        <td>
                                            <input class="form-check-input mt-1" type="checkbox" id="b4k9_4">
                                            <label class="form-check-label" for="b4k9_2"> 4. KTP </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input class="form-check-input mt-1" type="checkbox" id="b4k9_1">
                                            <label class="form-check-label" for="b4k9_2"> 1. Akta kelahiran </label>
                                        </td>
                                        <td>
                                            <input class="form-check-input mt-1" type="checkbox" id="b4k9_8">
...
<div class="modal fade" id="blok5Modal" tabindex="-1" role="dialog" aria-labelledby="blok5ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ url('/data/add/blok5table') }}" method="POST" id="blok5FormTable" class="form-tambah" autocomplete="off">
                @csrf
...
<div class="modal fade" id="blok7Modal" tabindex="-1" role="dialog" aria-labelledby="blok7ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ url('/data/add/blok7table') }}" method="POST" id="blok7FormTable" class="form-tambah" autocomplete="off">
                @csrf
...
<div class="card mb-4">
    <div class="card-body">
        <div class="row">
            <div class="list-group col-md-3 ps-2">
                <div id="bloknav">
                    ...
                    <a class="list-group-item list-group-item-action" style="background-color: red; color: white;"><strong>Sebelum menyimpan blok lain, Blok I harus disimpan terlebih dahulu</strong></a>
                </div>
            </div>
            <div class="col-md-9">
                <div id="blok1" class="targetDiv border border-dark p-2">
                    ...
                    <form action="{{ url('/data/add/blok1') }}" method="POST" id="blok1Form" class="form-tambah" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md">
                                <div class="form-floating">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="b1r8" name="b1r8" placeholder="b1r8" value="">
                ...
                <div id="blok2" class="targetDiv border border-dark p-2 mt-4">
                    ...
                    <form action="{{ url('/data/add/blok2') }}" method="POST" id="blok2Form" class="form-tambah">
                        @csrf
                ...
                <div id="blok3" class="targetDiv border border-dark p-2 mt-4">
                    ...
                    <form action="{{ url('/data/add/blok3') }}" method="POST" id="blok3Form" class="form-tambah">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <select type="text" class="form-select" id="b3r1b" name="b3r1b" placeholder="kode" style="height: 5.25rem; padding-top: 3.25rem;" disabled>
                                        <option value=""></option>
                                        <option value="1">1. Milik sendiri</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <select type="text" class="form-select" id="b3r4b" name="b3r4b" placeholder="kode" disabled>
                                        <option value=""></option>
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <select type="text" class="form-select" id="b3r5b" name="b3r5b" placeholder="kode" disabled>
                                        <option value=""></option>
                                        <option value="1">1. Bagus/kualitas tinggi</option>
                                        <option value="2">2. Jelek/kualitas rendah</option>
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <select type="text" class="form-select" id="b3r9b" name="b3r9b" placeholder="kode" disabled>
                                        <option value=""></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <select type="text" class="form-select" id="b3r11b" name="b3r11b" placeholder="kode" disabled>
                                        <option value=""></option>
                ...
                <div id="blok6" class="targetDiv border border-dark p-2 mt-4">
                    ...
                    <form action="{{ url('/data/add/blok6') }}" method="POST" id="blok6Form" class="form-tambah">
                        @csrf
                ...
                <div id="blok7" class="targetDiv border border-dark p-2 mt-4">
                    ...
                    <form action="{{ url('/data/add/blok7') }}" method="POST" id="blok7Form" class="form-tambah">
                        @csrf
